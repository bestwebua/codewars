=begin
Drunk friend by Vladislav Trotsenko.
...
However, none of the words he writes make sense to you. He wants to help you, so he
points at a beer and writes "yvvi". You start to understand what he's trying to say,
...
def decode(string)
  mirror = (('a'..'z').to_a + ('A'..'Z').to_a).join.reverse
  string.is_a?(String) ? string.tr('A-Za-z', mirror) : 'Input is not a string'
end
